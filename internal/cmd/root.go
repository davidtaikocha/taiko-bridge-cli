...
func NewRootCmd() *cobra.Command {
	...
	rootCmd.PersistentFlags().StringVar(&opts.SrcBridge, "src-bridge", "", "Source bridge address")
	rootCmd.PersistentFlags().StringVar(&opts.DstBridge, "dst-bridge", "", "Destination bridge address")
	rootCmd.PersistentFlags().StringVar(&opts.SrcSignal, "src-signal-service", "", "Source signal service address")
	rootCmd.PersistentFlags().StringVar(&opts.DstSignal, "dst-signal-service", "", "Destination signal service address")
	rootCmd.PersistentFlags().StringVar(&opts.SrcERC20Vault, "src-erc20-vault", "", "Source ERC20 vault address")
	rootCmd.PersistentFlags().StringVar(&opts.SrcERC721Vault, "src-erc721-vault", "", "Source ERC721 vault address")
	rootCmd.PersistentFlags().StringVar(&opts.SrcERC1155Vault, "src-erc1155-vault", "", "Source ERC1155 vault address")
